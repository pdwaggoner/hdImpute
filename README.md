...
See the detailed complementary paper (Forthcoming, *Computational Statistics*) introducing `hdImpute` along with several experiemental results [here](https://link.springer.com/article/10.1007/s00180-023-01325-9) or [here](./resfiles/hdimpute_paper.pdf)
